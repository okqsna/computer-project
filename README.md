...
мають більше ніж 1 вершину, застосовує до них Гамільтоновий цикл, цикл Ейлера, <br>
...
Далі йде перевірка чи граф неорієнтований (тобто чи містить він множини). Якщо він такий, то його перетворюються на орієнтований, замінюючи кожне ребро неорієнтованого графа двома ребрами, що мають напрямок.

#### Рекурсивна функція ```calculate_way```.

В основі цієї функції лежить алгоритм Флері, проте трохи модифікований.

У функцію передається поточне місцезнаходження та шлях, який вона пройшла щоб дістатись до цієї точки. Далі функція розглядає варіанти, по яких ребрах вона може далі піти. 
...
<img width="400" alt="Пошук Гамільтонового циклу" src="https://github.com/user-attachments/assets/73f7d4c0-46e3-42a3-8cc2-aa78fa37cc82">
