...
Дана бібліотека опрацьовує отримані на вхід графи з файлів з розширенням .dot, який містить граф,<br> 
що має більше ніж 1 вершину, застосовує до них Гамільтоновий цикл, цикл Ейлера, 
